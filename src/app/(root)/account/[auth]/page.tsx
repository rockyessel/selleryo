...
import SignOutBtn from '@/components/actions/sign-out';
...
const AuthenticationPage = async ({ params: { auth } }: Props) => {
          ...
          <div className='mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]'>
            <div className='flex flex-col space-y-2 text-center'>
              ...
              <p className='text-sm text-muted-foreground'>
                {auth === 'sign-in'
                  ? 'Go to your dashboard or sign-out from here.'
            ...
            {isUserSignedIn && session ? (
              <div className='grid gap-6'>
                <Link
                  href={'/dashboard'}
                  className='border p-2 rounded-lg bg-gray-200 flex items-start gap-3'
                >
                  <NextImage
                    ...
                    height={100}
                  />
                  <div className='text-black inline-flex flex-col'>
