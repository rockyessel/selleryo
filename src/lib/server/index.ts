...
import { CatchError, ResObj, UserProps } from '@/types';
import { IdGen } from '../utils/helpers';
import { Id } from '../../../convex/_generated/dataModel';

export const getServerUser = async (): Promise<UserProps | null> => {
...
export const validateUser = async (user: any): Promise<ResObj<any | null>> => {
